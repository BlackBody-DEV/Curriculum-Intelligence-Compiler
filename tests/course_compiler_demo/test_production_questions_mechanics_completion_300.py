from tools.course_compiler_demo.production_question_packs.mechanics.completion_300 import (
    audit_completion,
...
def test_mechanics_completion_adds_100_validated_diverse_questions():
...
def test_mechanics_completion_inventory_and_cumulative_audit():
    ...
    assert audit_completion() == {
        "course_id": "MECHANICS", "before": 200, "added": 100, "after": 300,
