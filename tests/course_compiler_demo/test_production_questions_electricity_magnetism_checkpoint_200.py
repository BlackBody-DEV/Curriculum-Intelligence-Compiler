from tools.course_compiler_demo.production_question_packs.electricity_magnetism.checkpoint_200 import (
    audit_checkpoint,
...
def test_em_checkpoint_adds_exactly_100_validated_questions():
...
def test_em_checkpoint_inventory_has_required_production_evidence():
...
def test_em_checkpoint_cumulative_duplicate_and_count_audit():
