from tools.course_compiler_demo.production_question_packs.modern_physics.completion_300 import audit_completion,build_completion_bank


def test_modern_physics_completion_300():
