from tools.course_compiler_demo.production_question_packs.waves_optics.checkpoint_200 import (
    audit_checkpoint,
...
def test_waves_optics_checkpoint_adds_100_validated_diverse_questions():
...
def test_waves_optics_checkpoint_inventory_domains_and_cumulative_audit():
    ...
    assert audit_checkpoint() == {
        "course_id": "WAVES_AND_OPTICS", "before": 100, "added": 100, "after": 200,
