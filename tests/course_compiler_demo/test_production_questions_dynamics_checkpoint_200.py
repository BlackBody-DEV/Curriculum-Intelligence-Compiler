from tools.course_compiler_demo.production_question_packs.dynamics.checkpoint_200 import audit_checkpoint,build_checkpoint_bank


def test_dynamics_checkpoint_200():
