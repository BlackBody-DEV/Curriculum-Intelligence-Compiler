"""Math 112 Calculus I completion: the final locked bank of 100 questions."""
...
def build_completion_bank():
    ...
    bank = replace(bank, bank_id="bank:CALCULUS_I:math-112-completion:v1")
    summary = replace(summary, summary_id="summary:CALCULUS_I:math-112-completion:v1")
    return bank, summary
