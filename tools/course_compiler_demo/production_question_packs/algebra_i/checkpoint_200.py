"""Math 110 Algebra I checkpoint: a second locked bank of 100 questions."""
...
def build_checkpoint_bank():
    ...
    bank = replace(bank, bank_id="bank:ALGEBRA_I:math-110-checkpoint:v1")
    summary = replace(summary, summary_id="summary:ALGEBRA_I:math-110-checkpoint:v1")
    return bank, summary
