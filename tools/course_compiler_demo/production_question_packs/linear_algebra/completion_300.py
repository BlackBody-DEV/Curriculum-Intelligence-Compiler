"""Math 128 Linear Algebra completion 300."""
...
def build_completion_300_bank():
 ...
 if p["validated"]!=25 or x["after"]!=100 or y["after"]!=200:raise ValueError("authoritative checkpoint 200 unavailable")
 return _build(list(p["questions"])+list(a)+list(b),200,100,40,"math128c300")
