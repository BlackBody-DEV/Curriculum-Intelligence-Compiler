"""Physics 111 Statics checkpoint: a third locked bank of 100 questions."""
...
def build_checkpoint_bank():
    ...
    bank = replace(bank, bank_id="bank:STATICS:physics-111-checkpoint-300:v1")
    summary = replace(summary, summary_id="summary:STATICS:physics-111-checkpoint-300:v1")
    return bank, summary
