"""Physics 111 E&M checkpoint: a second locked bank of 100 questions."""
...
def build_checkpoint_bank():
    ...
    bank = replace(bank, bank_id="bank:ELECTRICITY_AND_MAGNETISM:physics-111-checkpoint:v1")
    summary = replace(summary, summary_id="summary:ELECTRICITY_AND_MAGNETISM:physics-111-checkpoint:v1")
    return bank, summary
