"""Math 120 Trigonometry checkpoint: 100 questions taking the course to 200."""
    ...
    for source in sorted(accepted, key=lambda item: item["recipe"].recipe_id):
        ...
        for variant in range(FIRST_NEW_VARIANT, FIRST_NEW_VARIANT + 1000):
            ...
            rows.append({"question_id": question_id, "course_id": COURSE_ID,
                ...
                "difficulty": difficulties[family_added % len(difficulties)],
            ...
            family_added += 1
        if family_added != 20:
            raise ValueError("unable to allocate 20 unique variants for generation family")
