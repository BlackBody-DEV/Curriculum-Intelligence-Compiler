...
"TRIGONOMETRY":(("angle composition","Compose directed angles {a} and {b} degrees.","sum"),("right-triangle tangent ratio","For opposite leg {a} and nonzero adjacent leg {b}, compute tan(theta)=opposite/adjacent.","ratio"),("unit-circle Pythagorean normalization","Use positive seeds m={a}, n={b} to construct scaled coordinates x=m^2-n^2, y=2mn, r=m^2+n^2; select the coordinates satisfying x^2+y^2=r^2 and hence (x/r)^2+(y/r)^2=1.","unit_circle_pythagorean"),("amplitude scaling","Scale trigonometric amplitude {a} by factor {b}.","product"),("equation quotient","Isolate a trigonometric value by dividing equation side {a} by nonzero coefficient {b}.","ratio")),
...
def _build_registry()->dict[str,tuple[DomainRecipeV1,...]]:
    ...
    for course_id,semantic_bindings in SEMANTIC_BINDINGS.items():
        ...
        for position,(binding_index,concept) in enumerate(semantic_bindings,1):
            ...
            engine={"multiple_choice_product":"multiple_choice","unit_circle_pythagorean":"multiple_choice","matrix":"matrix","linear_root":"symbolic_expression","recurrence_step":"symbolic_expression"}.get(operation,"numeric_scalar")
